  ...
  extension: [
    {
      browser: 'chrome',
      link:
        venomExtensionLinkChrome !== null ? venomExtensionLinkChrome || venomDefaultLink : null
    }
  ]
};
  ...
  walletWaysToConnect: [
        ...
        devises: [
          {
            ...
            deepLink: 'https://apps.apple.com/app/venom-blockchain-wallet/id1622970889',
            alt: 'iOS',
            storeId: 'ios'
          },
          {
            ...
            deepLink: 'https://play.google.com/store/apps/details?id=com.venom.wallet',
            alt: 'Android',
            storeId: 'android'
          },
          {
    ...
    },
    {
      ...
      options: {
        ...
        deepLink: (links: typeof venomDefaultLinks | undefined = venomDefaultLinks) =>
