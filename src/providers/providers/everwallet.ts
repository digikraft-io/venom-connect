...
const everIosDeepLink = 'https://apps.apple.com/app/ton-crystal-wallet/id1581310780';
  ...
  extension: [
    {
      browser: 'chrome',
      link:
        everExtensionLinkChrome !== null ? everExtensionLinkChrome || everDefaultLink : null
    },
    {
      browser: 'firefox',
      link:
        everExtensionLinkFirefox !== null ? everExtensionLinkFirefox || everDefaultLink : null
    }
  ]
};
//
      ...
      options: {
        ...
        devises: [
          ...
          },
          {
            ...
            deepLink: (links: typeof everDefaultLinks | undefined = everDefaultLinks) =>
