  ...
  links => {
    if (links?.[key] !== null && !!id) {
      ...
      if (
        ...
        if (key === 'ios') {
          if (id === 'venomwallet') {
            return getVenomIos((userValue as { targetLink: string })?.targetLink || undefined);
          }
          if (id === 'oxychatwallet') {
            return getOxyIos((userValue as { targetLink: string })?.targetLink || undefined);
          }
          if (id === 'oneartwallet') {
            return getOneArtIos(
        ...
        if (key === 'qr') {
          if (id === 'venomwallet') {
            return getVenomQr((userValue as { targetLink: string })?.targetLink || undefined);
          }
          if (id === 'oxychatwallet') {
            return getOxyQr((userValue as { targetLink: string })?.targetLink || undefined);
          }
          if (id === 'oneartwallet') {
            return getOneArtQr((userValue as { targetLink: string })?.targetLink || undefined);
          }
        }
